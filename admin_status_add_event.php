...
?>
    ...
    <head>
        ...
        <title>ADMIN | เพิ่มงานนิทรรศการ</title>
                ...
                <nav class="navbar navbar-transparent navbar-absolute">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="admin_status_event.php"> เพิ่มงานนิทรรศการ</a>
                        </div>
...
<td><a href="admin_add_plan.php?event_id=<?php echo $data["event_id"];?>" class="btn btn-secondary">เพิ่มแปลน</a></td>
<td><a href="admin_add_banner.php?event_id=<?php echo $data["event_id"];?>" class="btn btn-info">เพิ่มแบนเนอร์</a></td>
<td><a href="admin_add_image.php?event_id=<?php echo $data["event_id"];?>" class="btn btn-success">เพิ่มภาพบรรยากาศงาน</a></td>
<td><a href="admin_add_document.php?event_id=<?php echo $data["event_id"];?>" class="btn btn-warning">เพิ่มเอกสารประกอบการจอง</a></td>
...
<tr>
<td><center><?php echo "$data[ev_name]"; ?></center></td>
<td><a href="admin_add_zone.php?event_id=<?php echo $data["event_id"];?>" class="btn btn-secondary">เพิ่มโซน</a></td>
<td><a href="admin_add_booth_status.php?event_id=<?php echo $data["event_id"];?>" class="btn btn-info">เพิ่มบูธ</a></td>
