...
?>
    ...
    <head>
        ...
        <title>ADMIN | แก้ไขข้อมูลผู้ดูแลระบบ</title>
            ...
            <div class="main-panel">
                <nav class="navbar navbar-transparent navbar-absolute">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="admin_edit_admin.php"> แก้ไขข้อมูลผู้ดูแลระบบ</a>
                        </div>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <form action="admin_update_admin.php" method="post" enctype="multipart/form-data">
<?php
...
?>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header" data-background-color="red">
                                        <h4 class="title">แก้ไขข้อมูลผู้ดูแลระบบ</h4>
 ...
 <input type="file" name="admin_image" id="admin_image" value="<?php echo "$data[admin_image]"; ?>" />   
