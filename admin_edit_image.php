        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="admin_edit_image.php"> แก้ไขภาพบรรยากาศงาน</a>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content table-responsive">
                                <form action="admin_update_image.php" method="post" enctype="multipart/form-data"> 
                                    <?php
                                                        ...
                                                        foreach($files1 as $key=>$value){
                                                            if($key>1){
                                                                ...
                                                                if(in_array($ext,$allowed_types)){
                                                                    ...
                                                                    echo "<center>";  
                                                                    echo "<button type='reset' name='reset' class='btn  btn-danger'>ลบ</button>";
                                                                    echo "<button type='submit' name='submit' class='btn btn-success'>บันทึก</button>";
                                                                    echo "</center>";
                                                                    echo "</div>"; 
                                                                }
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="file-loading">
                                                                    <input id="event_image" name="event_image[]" type="file" multiple>
