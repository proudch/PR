...
if(isset($_GET["event_id"]))
 ...
 $create_by = $mysqli->real_escape_string($_POST['name']);
      if($_FILES['event_image']['name'][0]){
        ...
        $filename = date("Ymdhis").$i.$_FILES['event_image']['name'][$i];
        $path = "_files/_event_image/".$filename;
        move_uploaded_file( $_FILES['event_image']['tmp_name'][$i], $path );
          

             $sql = "INSERT INTO event_images (event_id, name, file_path ,create_by)"
            . "VALUES('$id','$filename',  '$path', '$create_by')";
//เก็บข้อมูลลง DB
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="main-panel">
                <nav class="navbar navbar-transparent navbar-absolute">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="admin_add_image.php"> เพิ่มภาพบรรยากาศงาน</a>
                        </div>
                ...
                <div class="content">
                    <div class="container-fluid">
                        <form action="admin_add_image.php" method="post" enctype="multipart/form-data"> 
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header" data-background-color="red">
                                            <h4 class="title">เพิ่มภาพบรรยากาศงาน</h4>
