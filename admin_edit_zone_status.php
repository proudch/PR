...
$sql = "SELECT * FROM `zones` WHERE event_id = '".$id."' ";
$query = mysqli_query($con,$sql);
while ($data = mysqli_fetch_array($query) ) {
...
<td><a href="admin_edit_zone.php?zone_id=<?php echo $data["zone_id"];?>" class="btn btn-secondary">แก้ไขโซน</a></td>
<td><a href="delete_zone.php?zone_id=<?php echo $data["zone_id"];?>" class="btn btn-info">ลบโซน</a></td>
