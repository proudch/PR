...
$initialPreviewConfig = array();
  ...
  <head>
    ...
    <!-- Font Awesome Icon -->
    <link rel="stylesheet" href="css/s/font-awesome.min.css">

    <!-- Custom stlylesheet -->
    <link type="text/css" rel="stylesheet" href="css/s/style.css"/>
        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="admin_edit_document.php">  แกไขเอกสาร</a>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="red">
                                <h4 class="title"> แกไขเอกสาร</h4>
                                <!-- <p class="category">Here is a subtitle for this table</p> -->
                            </div>
                            <div class="card-content table-responsive">
                                <form action="admin_edit_document_doc.php" method="post" enctype="multipart/form-data"> 
                                    <?php
...
<tr>
<td><a href="_files/_document/<?php echo $data["name"];?>" target="_blank"><?php echo $data["name"];?></a></td>
...
<button type='button' class='btn btn-primary btn-simple btn-xs'>
                                 <i class='material-icons'><a href="admin_edit_document_doc.php?document_id=<?php echo $data["document_id"];?>">edit</i></a>
                                  </button>
                                </td>
                               ...
                               <td class='td-actions text-right'>
                                        ...
                                        "<i class='material-icons'><a href="delete_document.php?document_id=<?php echo $data["document_id"];?>">delete</i></a>
