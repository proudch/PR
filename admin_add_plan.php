...
isset($plan);
 $id = $_POST['event_id'];
  ...
  $filename = date("Ymdhis").$_FILES['plan']['name'][0];
   $path = "_files/_plan/".$filename;
  move_uploaded_file( $_FILES['plan']['tmp_name'][0],  $path );
    

    $sql = "INSERT INTO plans (event_id, name, file_path ,create_by)"
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="main-panel">
                <nav class="navbar navbar-transparent navbar-absolute">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="admin_add_plan.php"> เพิ่มแปลน</a>
                        </div>
                ...
                <div class="content">
                    <div class="container-fluid">
                        <form action="admin_add_plan.php" method="post" enctype="multipart/form-data"> 
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header" data-background-color="red">
                                            <h4 class="title">เพิ่มแปลน</h4>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <div class="file-loading">
                                                            <input id="plan" name="plan[]" type="file" multiple>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
