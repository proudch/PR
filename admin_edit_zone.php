    ...
    <div class="wrapper">
        <div class="sidebar" data-color="red">
            ...
            <div class="main-panel">
                ...
                <div class="content">
                    <div class="container-fluid">
                       <form action="admin_update_zone.php" method="post"> 
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label>ชื่องาน</label>
                                                <input class="form-control" type="text" id="name" name="name" placeholder="กรุณาใส่ชื่องาน" value="<?php echo "$data[name]"; ?>">
                                            </div>
                                        </div>
                                    </div>
