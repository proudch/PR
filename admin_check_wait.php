...
<?php
                             ...
                             while ($w_row = mysqli_fetch_array($w_query,MYSQLI_ASSOC)) {
                                ?>
                                <tr>
                                    <td><center><?php echo $w_row['b_name']; ?></center></td>
                                    <td><center><?php echo $w_row['size']; ?></center></td>
                                    <td><center><?php echo $w_row['price']; ?></center></td>
                                    <td><center><input type="hidden" name="status" value="'<?php echo $w_row['status']; ?>"'>รอชำระเงิน</td>
