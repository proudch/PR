    ...
    <div class="wrapper">
        <div class="sidebar" data-color="red">
            ...
            <div class="main-panel">
                <nav class="navbar navbar-transparent navbar-absolute">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="admin_add_document.php"> เพิ่มเอกสารประกอบการจอง</a>
                        </div>
                ...
                <div class="content">
                    <div class="container-fluid">
                        <form action="admin_update_document.php" method="post" enctype="multipart/form-data"> 
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header" data-background-color="red">
                                            <h4 class="title">เพิ่มเอกสารประกอบการจอง</h4>
...
//ถ้ามีการส่งค่าข้อมูล
                                                    ...
                                                    ?>  
                                            <input type="text"  name="event_id" id="event_id" value="<?php echo "$data[event_id]"; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <input type="text"  name="document_id" id="document_id" value="<?php echo "$data[document_id]"; ?>"> 


                                                    <a href="_files/_document/<?php echo $data["name"];?>" target="_blank"><?php echo $data["name"];?></a>
