...
?>
    ...
    <head>
        ...
        <title>ADMIN | เพิ่มข้อมูลบูธ</title>
...
?>
tr = tr + "<td><input class='form-control' type='text' name='b_name"+rows+"' id='b_name"+rows+"'></td>";
tr = tr + "<td><input class='form-control' type='text' name='size"+rows+"' id='size"+rows+"'></td>";
tr = tr + "<td><input class='form-control' type='text' name='price"+rows+"' id='price"+rows+"'></td>";
tr = tr + "<td><input class='form-control' type='hidden'  name='status"+rows+"' id='status"+rows+"' value='f'></td>";
tr = tr + "<td><input class='form-control' type='hidden'  name='zone_id"+rows+"' id='zone_id"+rows+"' value='<?php echo $data["zone_id"];?>'></td>";
                ...
                <nav class="navbar navbar-transparent navbar-absolute">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="admin_add_booth.php"> เพิ่มข้อมูลบูธ</a>
                        </div>
