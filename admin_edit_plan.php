                ...
                <nav class="navbar navbar-transparent navbar-absolute">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="admin_edit_plan.php"> แก้ไขแปลน</a>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-content table-responsive">
                                         <form action="admin_update_plan.php" method="post" enctype="multipart/form-data"> 
 <?php
...
$sql = "SELECT * FROM `plans` WHERE event_id = '".$id."' ";
$query = mysqli_query($con,$sql);
$data=mysqli_fetch_array($query,MYSQLI_ASSOC);
...
<img src="_files/_plan/<?php echo $data["name"];?>">
