...
if(isset($_GET["event_id"]))
 ...
 $create_by = $mysqli->real_escape_string($_POST['name']);
      if($_FILES['document']['name'][0]){
        ...
        $filename = date("Ymdhis").$i.$_FILES['document']['name'][$i];
        $path = "_files/_document/".$filename;
        move_uploaded_file( $_FILES['document']['tmp_name'][$i], $path );
          

             $sql = "INSERT INTO documents (event_id, name, file_path ,create_by)"
    ...
    <div class="wrapper">
        <div class="sidebar" data-color="red">
            ...
            <div class="main-panel">
                ...
                <div class="content">
                    <div class="container-fluid">
                        <form action="admin_add_document.php" method="post" enctype="multipart/form-data"> 
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
