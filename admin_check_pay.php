...
if (!$_SESSION["UserID"]){  //check session
  ...
  <head>
    ...
    <title>ADMIN | ชำระเงินแล้ว</title>
        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="admin_check_pay.php">ชำระเงินแล้ว</a>
                </div>
        ...
        <?php
                            ...
                            <div class="row">
                             ...
                             while ($p_row = mysqli_fetch_array($p_query,MYSQLI_ASSOC)) {
                                ?>
                                <tr>
                                    <td><center><?php echo $p_row['b_name']; ?></center></td>
                                    <td><center><?php echo $p_row['size']; ?></center></td>
                                    <td><center><?php echo $p_row['price']; ?></center></td>
                                    <td><center><input type="hidden" name="status" value="'<?php echo $p_row['status']; ?>"'>ชำระเงินแล้ว</center></td>
                                    <td><center><a href="admin_edit_document.php?event_id=<?php echo $data["event_id"];?>" class="btn btn-primary">รายละเอียด</a></center></td>
